...
/**
 * PowerConverter - Converts between power units: Watts, Kilowatts, Horsepower, BTU/hr, etc.
 */
export default function PowerConverter({ toolId, toolName }: { toolId: string; toolName: string }) {
  ...
  const UNITS = [
    ...
    { value: 'metric-hp', label: 'Metric HP (PS)' },
    { value: 'btu-hr', label: 'BTU/hour' },
    { value: 'ft-lb-s', label: 'Foot-pound/second' },
    { value: 'calorie-s', label: 'Calorie/second' },
  ...
  return (
    <div className="space-y-4" data-tool-id={toolId}>
      ...
      <button onClick={convert} aria-label="Convert power" className="btn-primary">Convert</button>

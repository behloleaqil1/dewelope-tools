...
import { base64Encode, base64Decode } from '@/lib/developer-tools';

const MAX_LENGTH = 1048576; // 1MB

/**
 * Base64EncoderDecoder - Encode/decode text to/from Base64.
 * Preserves input on error, provides copy button for output.
 * Requirements: 6.2, 6.5, 6.6, 6.7
 */
export default function Base64EncoderDecoder({ toolId }: ToolEngineProps) {

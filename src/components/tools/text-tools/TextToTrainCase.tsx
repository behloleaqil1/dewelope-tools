...
/**
 * TextToTrainCase - Converts text to Train-Case format.
 * Capitalizes each word and joins with hyphens (e.g., "Hello-World-Example").
 */
      ...
      <OutputArea hasContent={!!output}>
        {output && (
          <div className="space-y-2">
            <label className="block text-sm font-medium text-gray-700">Train-Case Result</label>

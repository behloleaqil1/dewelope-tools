...
import { removeDuplicateLines } from '@/lib/text-tools';
import { validateTextLength } from '@/lib/validation';

const MAX_LENGTH = 100000;

/**
 * RemoveDuplicateLines - Removes duplicate lines from text, keeping first occurrence.
 * Uses 500ms debounce for real-time output.
 * Requirements: 4.2, 4.3, 4.4, 4.5, 4.6
 */
export default function RemoveDuplicateLines({ toolId, toolName: _toolName }: ToolEngineProps) {
    ...
    <div className="space-y-4">
      <InputArea error={error}>
        ...
        <textarea
          ...
          placeholder="Paste or type text with duplicate lines to remove them..."
